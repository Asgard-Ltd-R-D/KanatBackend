...
class DockerService(Protocol):
    ...
    def prepare_images(self, env: str, images: Iterable[str], image_cache_dir: Path, deploy_dir: Path, questdb_dir: Path) -> bool: ...
...
class DotnetService(Protocol):
    ...
    def run_packetprocessing(self, dll_path: Path, environment: str) -> int: ...
